        ...
        <section css={HowToBuyWrapper}>
            ...
            <div css={containerGrid}>
                <div css={gridItem}>
                    ...
                    <p>Write down your recovery phrase. Store this phrase in a safe place and never share this phrase with anyone.</p>
                </div>
                <div css={gridItem}>
                    <h4>Buy BNB Smartchain token</h4>
                    <p>Go to the BNB Smartchain token inside the app. Click on "Buy" at the right top and select the amount of BNB Smart chain tokens you want to buy.
                        If this is not available in your app due to your country, buy BNB on an exchange and send this to your Trustwallet.</p>
                </div>
                <div css={gridItem}>
                ...
                <div css={gridItem}>
                    ...
                    <p>Open the trustwallet app. Go to the browser tap and search for pancakeswap.</p>
                </div>
                <div css={gridItem}>
